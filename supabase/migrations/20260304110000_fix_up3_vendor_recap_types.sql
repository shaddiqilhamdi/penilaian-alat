-- ============================================================================
-- Fix fn_up3_vendor_recap & fn_up3_equipment_issues return types
-- peruntukan_id is TEXT not UUID, vendor_id in some tables may also be TEXT
-- ============================================================================

-- Drop and recreate fn_up3_vendor_recap with correct types

-- Fix fn_unit_report: tambah total_regu di peruntukan breakdown, owner_label di issues
...
BEGIN
    ...
    -- 2. Breakdown per Peruntukan + kolom Regu
    -- total_regu = COUNT item dimana owner_id = team_id (tim sebagai pemilik)
    ...
    -- owner_label: jika owner = team → nomor_polisi kendaraan, jika bukan → nama personil
            ...
            jsonb_build_object(
                ...
                'items', jsonb_agg(
                    jsonb_build_object(
                        ...
                        -- owner_label: nopol jika tim, nama jika personil
                        'owner_label', CASE
